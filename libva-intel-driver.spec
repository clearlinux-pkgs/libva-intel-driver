...
Patch1: backport-Make-wl_drm-optional.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722523911
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Denable_hybrid_codec=true  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Denable_hybrid_codec=true  builddiravx2
...
cp %{_builddir}/intel-vaapi-driver-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libva-intel-driver/099b1aff1b937aad419a0cc7cfb474d2d74acf0b || :
cp %{_builddir}/intel-vaapi-driver-%{version}/test/gtest/LICENSE %{buildroot}/usr/share/package-licenses/libva-intel-driver/5a2314153eadadc69258a9429104cd11804ea304 || :
GOAMD64=v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/dri/i965_drv_video.so
